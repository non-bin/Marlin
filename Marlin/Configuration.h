...
#define STRING_CONFIG_H_AUTHOR "(Alice, Creality Ender-5 Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Felice (E5Plus)"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "72ade3b9-b898-4d8e-a956-5adae29ded4f"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 181.55
  #define DEFAULT_bedKi 24.09
  #define DEFAULT_bedKd 912.16
...
#define XY_AFTER_HOMING { 180, 180 }  // (mm) Move to an XY position after homing (and raising Z)
